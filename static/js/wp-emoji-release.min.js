            ...
            parse: function (d, u) {
                ...
                return ("string" == typeof d ? function (d, a) {
                    ...
                    var f, c, e, b, a, t, n, r, o, i, s, l = function d(u, f) {
                        ...
                        p = l.length;
                    for (; p--;) {
                        for (e = !1, b = document.createDocumentFragment(), a = l[p], t = a.nodeValue, n = 0; i = m.exec(t);) {
                            if ((s = i.index) !== n && b.appendChild(g(t.slice(n, s), !0)), o = i[0], i = x(o), n = s + o.length, s = u.callback(i, u), i && s) {
